...
Around the same time, CIVICUS---a research and advocacy organization focused on civil society---launched its Civil Society Index (CSI), which used expert surveys to rate the legal environment of 30 to 50 states along four dimensions: the sector's structure, external environment, values, and impact [@Heinrich:2004]. In the 2010s, the CSI evolved into the CIVICUS Monitor [@CIVICUS:2024], which uses expert surveys and quantitative human rights indicators to generate scores on a scale of 1 to 100 with five levels of civic space: open, narrowed, obstructed, repressed, and closed. CIVICUS Monitor scores are based on a weighted average of common measures for freedom of association, assembly, and expression [@CIVICUS:2024a] and are thus conceptually broader than just civil society repression. However, the project has wide coverage, with annual scores for 196 countries since 2018, and could prove useful for future research on the repression of civic space more generally.

Researchers have also extracted details of civil society repression from broader human rights datasets. Among the rights measured by the CIRI Human Rights Project [@CingranelliRichardsClay:2014] is a three-category measure of assembly and association freedom based on US State Department reports, capturing how easily citizens can participate in trade unions, cultural organizations, or domestic and international NGOs. Each year, countries receive a score---severely restricted, limited, and unrestricted---based on the severity and universality of civil society restrictions. CIRI data are available for nearly 200 countries annually, with scores beginning in 1981, making it ideal for cross-sectional analysis. However, with only three possible outcomes, the data fails to pick up minor changes in the civil society regulatory environment [@BakkeMitchellSmidt:2020].
...
The Varieties of Democracy project has emerged as perhaps the most comprehensive source for measuring *de facto* conditions [@CoppedgeGerringKnutsen:2025]. Using a sophisticated Bayesian IRT measurement model based on thousands of expert surveys, V-Dem provides hundreds of democracy-related indicators and indices for 202 countries from 1789 to 2025, including several focused specifically on civil society regulations. V-Dem's Core Civil Society Index (CCSI) is a weighted average of indices related to the strictness of CSO entry and exit requirements, the openness of public participation in CSOs, and the severity of government repression that is targeted specifically at CSOs [@BernhardTzelgovJung:2015]. Many studies on civil society repression now rely on both the CCSI and its more specific index of civil society repression [@SpringmanMaleskyRight:2022; @ChaudhryComstockHeiss:2024].
...
The data on barriers to CSO entry, funding, and advocacy in 98 countries initially collected by @ChristensenWeinstein:2013 have proven valuable as a foundation for ongoing data collection on formal NGO laws---both @GlasiusSchalkDeLange:2020 and @Chaudhry:2022 use the same categorization of laws, while @BromleySchoferLonghofer:2020 use many of the same sources. Each of these data collection projects ends its coverage somewhere between 2012 and 2016, and each covers a different set of countries and laws: @BromleySchoferLonghofer:2020 look at nearly every country but only examine foreign funding laws, while @GlasiusSchalkDeLange:2020 and @Chaudhry:2022 look at a wider range of laws in 100 to 130 countries.
